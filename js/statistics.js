...
// Globally store a reference to the graph currently being displayed
var current_chart;

// Update current chart being displayed
function updateCurrentChart() {
  switch (current_chart) {
    case 'nutrition':
      // Call update weekly nutrition function
      weeklyNutrition();
      break;
    case 'calories':
      // Call update weekly calories function
      weeklyCalories();
      break;
    case 'protein':
      // Call update weekly protein function
      weeklyProtein();
      break;
  }
}
...
function weeklyCalories() {
  // Set current chart to 'calories'
  current_chart = 'calories';
...
function weeklyProtein() {
  // Set current chart to 'protein'
  current_chart = 'protein';
  // Request - requests all calories for every food item added within 7 days
  $.ajax({
    type: "GET",
...
function weeklyNutrition() {
  // Set current chart to 'nutrition'
  current_chart = 'nutrition';
  // Request - requests all calories for every food item added within 7 days
  $.ajax({
    type: "GET",
